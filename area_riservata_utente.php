...
<?php
    ...
    }}  else{$outCat.= "<div><h3> Non ci sono tour a cui partecipi. <a href='tour.php' class='messageTour' tabindex='".tabIndex($tab)."' accesskey='i'> Iscriviti </a>al tuo primo tour!</h3></div>";}
        echo $outCat;
        unset($outCat);
    ?>
    ...
    <?php
            ...
            $tab=$tab+1;
            $outCat.= "<div><h3> Non ci sono tour a cui partecipi. <a href='tour.php' class='messageTour' tabindex='".tabIndex($tab)."' accesskey='s'> Iscriviti </a>al tuo primo tour!</h3></div>";}
        echo $outCat;
        unset($outCat);
    ?>
