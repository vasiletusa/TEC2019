...
<div class="box-centrale">
	...
	<form method="post" action="registrazione_azienda.php" >						
								...
								<div >
									...
									<input id="NomeReferente" type="text" name="NomeReferente" class="input insertBox" placeholder="Nome referente" tabindex="10">
								...
								<div >
									...
									<input id="EmailReferente" type="email" required name="EmailReferente" class="input insertBox" placeholder="E-mail referente" tabindex="11">
