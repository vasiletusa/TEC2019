...
<div class="box-centrale">
	...
	<form method="post" action="registrazione_azienda.php" >						
								...
								<div >
									...
									<input id="NomeReferente" type="text" name="NomeReferente" class="input insertBox" placeholder="Inserire nome referente">
								...
								<div >
									...
									<input id="EmailReferente" type="email" required name="EmailReferente" class="input insertBox" placeholder="Inserire E-mail referente">
								...
								<div>
									...
									<input id="Username" type="text" name="Username" class="input username insertBox" placeholder="Inserire Username">
